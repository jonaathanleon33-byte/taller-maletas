        ...
        {!comprobante ? (
          ...
          <>
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-purple-600 py-3 text-center text-base font-semibold text-white shadow-md shadow-purple-600/20 active:bg-purple-700"
            >
              Imprimir en sticker
            </Link>
